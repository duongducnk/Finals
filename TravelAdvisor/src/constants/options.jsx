export const SelectTravelList = [
    {
        id:1,
        title: 'One person',
        desc: 'A traveler on an exploration',
...
export const SelectBudgetOptions=[
    ...
    },
    {
        id: 2,
        title: 'Moderate',
        desc: 'Always keep a way out for yourself',
        icon:<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
    ...
    },
    {
        id: 3,
        title: 'Luxury',
        desc: 'Why have to worry about cost when traveling',
        icon:<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
...
export const AI_PROMPT='Generate travelPlan (not array) For Location: {location} for {people} with a {budget} budget in {travelDays} days, give me hotelOptions list with hotelName, hotelAddress, hotelPrice (in VND), hotelImageURL, geoCoordinates, rating, descriptions and suggest itinerary (array) with day labeled (example day: 1, day: 2...), placeToVisit (array) (at least one for morning, one for afternoon, one for evening) in each day with placeName, placeDetails, placeImageURL, geoCoordinates, ticketPrice (in VND), bestTimeToVisit, timeToExplore each of the location, placeToEat (array) (in placeToVisit) (including breakfast, lunch, dinner corresponding to each location in placeToVisit) with placeName, placeAddress, placeImageUrl, geoCoordinates, price in JSON format (and there must be no null variable in response)'