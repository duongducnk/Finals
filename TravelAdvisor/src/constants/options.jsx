...
export const AI_PROMPT='Generate travelPlan (not array) For Location: {location} for {people} with a {budget} budget in {travelDays} days, give me hotelOptions list with hotelName, hotelAddress, hotelPrice (in VND), hotelImageURL, geoCoordinates, rating, descriptions and suggest itinerary with day labeled (example day: 1, day: 2...), placeToVisit(array) (at least one for morning, one for afternoon, one for evening) in each day with placeName, placeDetails, placeImageURL, geoCoordinates, ticketPrice (in VND), bestTimeToVisit, timeToExplore each of the location, placeToEat(array) (including breakfast, lunch, dinner near each location in placeToVisit) with placeName, geoCoordinates, price in JSON format (and there must be no null variable in response)'